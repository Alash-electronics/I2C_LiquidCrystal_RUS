#ifndef _I2C_LiquidCrystal_RUS_h
#define _I2C_LiquidCrystal_RUS_h
...
#include <Print.h>
#include <Wire.h>
#include "font_I2C_LiquidCrystal_RUS.h"
...
//Описание класса I2C_LiquidCrystal_RUS
...
class I2C_LiquidCrystal_RUS : public LCD_LIB {
  public:
#if (_LCD_TYPE == 1)
    I2C_LiquidCrystal_RUS (uint8_t lcd_Addr, uint8_t lcd_cols, uint8_t lcd_rows, uint8_t user_custom_symbols = 0) : LCD_LIB (lcd_Addr, lcd_cols, lcd_rows) { //Конструктор для подключения I2C
      init_priv(user_custom_symbols);
    }
#elif (_LCD_TYPE == 2)
    I2C_LiquidCrystal_RUS (uint8_t rs,  uint8_t enable,
